...
- Coca-Cola Sales Dashboard: Completed an interactive Coca-Cola USA Retailer Dashboard project, analyzing 2022-2023 sales data to uncover key trends, highlight brand performance, and generate actionable insights.
- Bike Shop Sales Dashboard: Analyze bicycle shop sales data to identify revenue drivers, understand customer behavior, and optimize strategies, with a focus on uncovering seasonal trends and market opportunities for business growth.
